...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/dev-test/").permitAll().antMatchers("/dev-test/players").authenticated()
				.antMatchers("/dev-test/game*").permitAll().antMatchers("/dev-test/users*").permitAll().anyRequest()
